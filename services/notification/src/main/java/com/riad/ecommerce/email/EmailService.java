...
import com.riad.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        messageHelper.setFrom("riadsiaka2002@gmail.com");
        ...
        try{
            ...
            log.info(String.format("INFO - Email succefully sent to %s with template %s" , destinationEmail , templateName));
